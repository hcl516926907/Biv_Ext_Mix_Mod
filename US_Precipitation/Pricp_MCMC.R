...
print(t2-t1)
Y.fit <- Y
save(Y.fit ,total.dist.name, results, file=file.path(dir.out, 'Pricp_res_78_79_3332_thres_0.01_0.90_0.99_sd_1.RData') )

# # load(file=file.path(dir.out, 'daily_index_res.RData') )
# plot(results$samples[2300:2499,'thres[1]'],type='l')
# 
