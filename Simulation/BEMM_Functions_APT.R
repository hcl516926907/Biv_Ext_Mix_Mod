run_MCMC_parallel <- function(seed, dat, niter, nburnin, thin){
  ...
  cov_chol <- nimbleFunction(
    run = function(rho = double(0), vec = double(1)) {
      returnType(double(2))
      out <- diag(vec) %*% matrix(c(1,rho,rho,1),ncol=2) %*% diag(vec)
      return(chol(out))
    })
  ...
  assign('cov_chol', cov_chol, envir = .GlobalEnv)
  ...
  BivExtMixcode <- nimbleCode({
    ...
    rho ~ dunif(-1,1)
    U[1:D,1:D] <- cov_chol(rho, sds[1:D])
  ...
  BivExtMixconf$removeSamplers()
  BivExtMixconf$addSampler("sds[1]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("sds[2]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("rho", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("mu[1]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("mu[2]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("thres[1]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("thres[2]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[1]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[2]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[3]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[4]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[5]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[6]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  BivExtMixconf$addSampler("theta[7]", type="sampler_RW_tempered", control=list(temperPriors=TRUE))
  #> ===== Monitors =====
  #> thin = 1: centroids
  #> ===== Samplers =====
  ...
  aptR <- buildAPT(BivExtMixconf, Temps=1:5, ULT= 1000, print=TRUE)
  ...
  set.seed(seed)
  aptC$run(niter = niter, thin=thin)
  results <- as.matrix(aptC$mvSamples)
  return(results)
}
