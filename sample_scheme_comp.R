...
qqplot(c(sp.bulk.1, sp.tail.1),c(sp.bulk.2, sp.tail.1), main='Scheme1 against Scheme 2')
...
qqplot(c(sp.bulk.1, sp.tail.1),sp, main='Scheme1 against Scheme 3')
qqplot(c(sp.bulk.1, sp.tail.1),sp1, main='Scheme1 against Scheme 3, pi=0.99')
