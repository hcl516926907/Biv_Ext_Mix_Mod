...
#v1 include the missing covariates V4 in the qgam model
save(result, file=file.path(dir.out, 'bootstrap_result_v1.RData'))
# 
# 
# 
# 
...
# p <- ggplot(df.all, aes(x = idx, y = estimate, color = model)) +
...
# res <- 500
# png(filename = file.path(dir.out, "bootstrap_ci.png"), width = 6*res, height = 5*res, res=res)
# print(p)
# dev.off()
# 
